...
# data_path = 'titanic3.xls'
# df_data = pd.read_excel(data_path)
#
# selected_cols = ['survived','name','pclass','sex','age','sibsp','parch','fare','embarked']
#
# select_df_data = df_data[selected_cols]
# select_df_data.info()
# figure,axis = plt.subplots(1,2)
# sns.barplot(x = 'pclass',y  ='survived', data=select_df_data,ax=axis[0])
# sns.barplot(x = 'sex',y  ='survived', data=select_df_data,ax=axis[1])
# plt.show()
